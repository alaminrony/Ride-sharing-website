    ...
    <div class="content">
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                <form class="form" method="POST" action="{{route('passenger.login.post')}}">
                    @csrf
                    <div class="card card-login">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control{{ $errors->has('p_email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" type="email" name="p_email" value="{{ old('p_email') }}" required autofocus>
