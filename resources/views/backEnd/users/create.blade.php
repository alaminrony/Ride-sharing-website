            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">@lang('lang.CREATE_USER')  <i class="nc-icon nc-single-02"></i></h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                {!! Form::select('group_id', $groups,null,['class'=>'form-control','placeholder'=> Lang::get('lang.GROUP')])!!}
