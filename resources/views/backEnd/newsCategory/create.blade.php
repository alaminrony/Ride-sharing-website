                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                             ...
                             <div class="input-group col-md-6">
                                ...
                                {!! Form::text('bg_color',old('bg_color'),['class' => 'form-control jscolor','placeholder' =>Lang::get('lang.TITLE')]) !!}
                        ...
                        <div class="row">
                            <div class="input-group col-md-6">
                                ...
                                {!! Form::text('icon_name',old('icon_name'),['class' => 'form-control','placeholder' =>Lang::get('lang.ICON_NAME')]) !!}
                        ...
                        <div class="row">
                              <div class="input-group col-md-6">
                                ...
                                {!! Form::select('type', ['0' => 'Driver', '1' => 'Passenger'],null,['class'=>'form-control','placeholder' =>Lang::get('lang.GROUP_BY')])!!}
                                @if ($errors->has('type'))
                                <span class="invalid-feedback" style="display: block;" role="alert">
