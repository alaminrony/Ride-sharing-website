            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">@lang('lang.CREATE')  @lang('lang.BILL_SETTINGS' ) 
                                {{-- <i class="nc-icon nc-single-02"></i></h3> --}}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            <div class="input-group col-md-6 option_value" >
                               ...
                               {!! Form::select('billchargeoptionvalue_id',['0'=>'nothing'] ,null,['class'=>'form-control','disabled'=>'disabled','placeholder'=> Lang::get('lang.BILL_CHARGE_SUB_OPTION')])!!}
                        ...
                        <div class="row">
                            ...
                            <div class="input-group col-md-6">
                               ...
                               {!! Form::text('tryal_period',old('tryal_period'),['class' => 'form-control','placeholder' =>Lang::get('lang.TRIAL_PERIOD')]) !!}
