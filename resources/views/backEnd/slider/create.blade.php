            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">@lang('lang.ADD') @lang('lang.SLIDER') <i class="nc-icon nc-single-02"></i></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                             <div class="input-group col-md-6">
                                <div class="input-group-prepend">
                                  ...
                                  {!! Form::file('image',['class' => 'form-control','placeholder' =>Lang::get('lang.SLIDER')]) !!}
                                @if ($errors->has('image'))
                                <span class="invalid-feedback" style="display: block;" role="alert">
