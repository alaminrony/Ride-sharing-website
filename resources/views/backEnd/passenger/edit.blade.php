                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            <div class="input-group col-md-6">
                                ...
                                {!! Form::text('full_name',$passenger->full_name,['class' => 'form-control','placeholder' =>Lang::get('lang.FULL_NAME')]) !!}
                        ...
                        <div class="row">
                            <div class="input-group col-md-6">
                                ...
                                {!! Form::text('phone',$passenger->phone,['class' => 'form-control','placeholder' =>Lang::get('lang.PHONE')]) !!}
                                @if ($errors->has('phone'))
                                <span class="invalid-feedback" style="display: block;" role="alert">
                            ...
                            <div class="input-group col-md-6">
                                ...
                                {!! Form::email('email',$passenger->email,['class' => 'form-control','placeholder' =>Lang::get('lang.EMAIL')]) !!}
                                @if ($errors->has('email'))
                                <span class="invalid-feedback" style="display: block;" role="alert">
