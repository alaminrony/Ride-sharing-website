                    ...
                    <div class="update-vehicles">
                        <div class="vehicles-photo">
                            <div>
                                ...
                                <input type="file" name="photo" style="display:none" id="browsCarAdd" accept="image/*">
                        ...
                        <div class="inputField">
                            <div class="form-group inputFiedl-inner">
                                ...
                                <input type="text" id="exampleInputEmail1"  placeholder="Enter Model" name="model_number" value="{{$vehicle->model_number}}"> 
                            ...
                            <div class="form-group inputFiedl-inner">
                                <select id="exampleFormControlSelect1" name="cabtype_id">
                                    ...
                                    <option value="{{$key}}" <?= $vehicle->cabtype_id == $key ? ' selected="selected"' : ''; ?>>{{$cab}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                <div class="passenger-grid">
                                    ...
                                    <input type="hidden" name="passenger_capacity" id="passengerCapacity" value="{{$vehicle->passenger_capacity}}">
                                    <div>
                                        <p>Children</p>
                                    </div>
                                    <div>
                                    ...
                                    <input type="hidden" name="children" id="childrenCapacity" value="{{$vehicle->children}}">
                                    <div>
                                        <p>Wheel Chair</p>
                                    </div>
                                    <div>
...
<!--                                        <ul class="list-inline countNumber pt-2" id="wheelchairNumber">
                                ...
                                <div class="btn-bottom text-center">
                                    <button id="updateVehiclesFormSubmit">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
