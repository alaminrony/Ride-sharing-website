        ...
        <div class="dashboard-grid">
            ...
            <div class="right-dashbord-content">
                <div class="header-input-field">
                    <form action="{{url('passenger-complete-ride-history-filter')}}">
                        ...
                        <table id="cancle-customers">
                            ...
                            <tbody>
                                ...
                                <tr class="spacer">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between moveDiv">
                                            <p><a href="{{url('passenger-ride-details?passengerId='.$passenger->id.'&ride_id='.$cabRide->id)}}" class="btn btn-secondary"><i class="fa fa-eye text-light"></i></a></p>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
